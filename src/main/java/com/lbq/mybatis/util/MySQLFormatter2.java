 ...
 *
 */
public class MySQLFormatter2 {
	private static final Set<String> BEGIN_CLAUSES = new HashSet<String>();//开始条款  
    private static final Set<String> END_CLAUSES = new HashSet<String>();//结束条款
    private static final Set<String> LOGICAL = new HashSet<String>();  //逻辑上 
...
//            result.append( initial );  
      ...
      public static void main(String[] args) {  
        String sql = MySQLFormatter2.format("select id, name from t_sss where id = ? and name = ?");  
